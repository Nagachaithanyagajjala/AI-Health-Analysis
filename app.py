...
HEALTH_RISK_KEYWORDS = {
    ...
    "hypertension": 9, "high blood pressure": 9,
    "heart disease": 10, "coronary artery disease": 10,
    "heart attack": 10, "myocardial infarction": 10,
    "stroke": 10, "arrhythmia": 8, "atherosclerosis": 9,

    # 🍬 Metabolic Disorders
    "diabetes": 10, "type 2 diabetes": 10,
    "insulin resistance": 9, "hyperglycemia": 9,
    "obesity": 8, "metabolic syndrome": 9,

    # 🫁 Respiratory Risks
    "asthma": 7, "copd": 10, "chronic obstructive pulmonary disease": 10,
    "lung infection": 8, "pneumonia": 9,
    "tuberculosis": 10, "respiratory failure": 10,

    # 🧬 Cancer & Tumors
    "cancer": 10, "tumor": 9, "malignancy": 10,
    "carcinoma": 10, "leukemia": 10, "lymphoma": 10,
    "metastasis": 10,

    # 🦠 Infectious Diseases
    "infection": 8, "sepsis": 10,  
    "covid": 9, "covid-19": 9,
    "hepatitis": 9, "hiv": 10, "aids": 10,
    "influenza": 7, "viral infection": 8, "bacterial infection": 8,

    # 🧠 Mental Health
    "depression": 8, "anxiety": 7,
    "bipolar disorder": 9, "schizophrenia": 10,
    "suicidal": 10, "mental stress": 7,

    # 🧍 Lifestyle Risks
    "smoking": 9, "tobacco use": 9,
    "alcoholism": 9, "drug abuse": 10,
    "sedentary lifestyle": 8, "physical inactivity": 8,
    "poor diet": 7,

    # 🧪 Organ & System Failures
    "kidney failure": 10, "renal failure": 10,
    "liver disease": 9, "cirrhosis": 10,
    "organ failure": 10,

    # 🧬 Other Critical Conditions
    "anemia": 7, "thyroid disorder": 7,
    "hypothyroidism": 7, "hyperthyroidism": 7,
...
llm = ChatGroq(model_name="llama-3.1-8b-instant", temperature=0.3, api_key=api_key)
...
def assess_risks(document_text):
    ...
    "Cardiovascular Risks": [
        "hypertension", "heart disease", "heart attack", "stroke",
    ...
    "Infectious Diseases": [
        "infection", "sepsis", "covid", "hepatitis", "hiv"
    ],

    "Cancer Risks": [
        "cancer", "tumor", "malignancy", "metastasis"
    ],
    ...
    "Lifestyle Risks": [
        "smoking", "alcoholism", "sedentary lifestyle", "poor diet"
    ],

    "Organ Failure Risks": [
        "kidney failure", "liver disease", "cirrhosis"
    ]
}
...
if document_text:
    ...
    with tab4:
        ...
        if gdpr_issues:
            ...
            gdpr_report = "✅ No major compliance risks detected in the document."
